...
public class Generator {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("");
        System.out.print("What level number should we start with? : ");
        generator.startingLevelNumber = scanner.nextInt();
    ...
    private void generateFile(int levelNumber) {
        ...
        int newLevelNumber = startingLevelNumber + levelNumber - 1;

        // Create board file
        try {
            // Create a new FileWriter object with name of level
            FileWriter myWriter = new FileWriter("levels/" + newLevelNumber + ".txt");
            String text = "";
        ...
        try {
            // Create a new FileWriter object with name of level
            FileWriter myWriter = new FileWriter("levels/" + newLevelNumber + "_orientations.txt");
